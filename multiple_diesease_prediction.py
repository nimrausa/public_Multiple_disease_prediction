...
def display_reviews_and_ratings(selected_disease):
    ...
    if not existing_reviews:
        st.write(" It's incredibly user-friendly, making it accessible to anyone, regardless of their technical expertise. What I love most is how easy it is to understand.The interface is intuitive, and the predictions are presented in a clear and straightforward manner.⭐️⭐️⭐️⭐️⭐️")
    else:
